...
public class C42_Card {
     ...
     */
    public C42_Card(int rank, int suit ) {
        this.suit = suit % 4;
        this.rank = rank % 13;
    }
     ...
     */
    public boolean sameSuit(C42_Card c) {
     ...
     */
    public boolean sameRank(C42_Card c) {
     ...
     */
    public boolean sameCard(C42_Card c) {
     ...
     */
    public int rankDiff(C42_Card c) {
        return (this.rank - c.rank);
    }
